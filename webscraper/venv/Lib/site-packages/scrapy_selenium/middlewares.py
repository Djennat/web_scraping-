...
class SeleniumMiddleware:
    ...
    def __init__(self, driver_name, driver_executable_path, driver_arguments,
        ...
        # Initialize Service with executable_path
        service = service_klass(executable_path=driver_executable_path)

        # Initialize Options and add arguments
        options = driver_options_klass()
        ...
        try:
            self.driver = driver_klass(service=service, options=options)
